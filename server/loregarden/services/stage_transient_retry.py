...
def transient_failure_reason(status: RunStatus, *, stdout: str, stderr: str) -> str:
    ...
    narrowing the module docstring argues: a clean exit with no stage report is
    not counted here. The caller must have ruled out a usage limit and an
    agent-reported verdict first.
    """
