...
export function SettingsModal({
  ...
  }, [open, workspace?.cli_adapter, workspace?.claude_model, workspace?.cursor_model, workspace?.lmstudio_base_url, workspace?.lmstudio_model, workspace?.claude_effort, workspace?.cursor_effort, workspace?.lmstudio_effort, workspaceSlug]);
